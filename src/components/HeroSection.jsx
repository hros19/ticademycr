...
function HeroSection() {
  ...
  return (
    ...
    >
      ...
      <button onClick={nav("/planes")} className="rounded-full mt-5 p-3 sm:p-4 md:p-5 bg-[#2A0800] text-lg sm:text-xl md:text-2xl font-semibold font-Poppins text-[#FFC6B2] hover:bg-red-500 hover:text-white hover:shadow-xl hover:scale-110 transform transition-all duration-500">
